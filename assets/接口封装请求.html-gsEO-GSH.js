import{_ as s}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as t,d as p,a as n,e}from"./app-oGr5u-1Z.js";const o={},c=n("p",null,"--- title: 接口封装请求 category:",-1),l=n("ul",null,[n("li",null,"前端 tag:"),n("li",null,"uniapp")],-1),i=n("hr",null,null,-1),u=n("p",null," ",-1),r=e(`<h1 id="接口封装请求" tabindex="-1"><a class="header-anchor" href="#接口封装请求" aria-hidden="true">#</a> 接口封装请求</h1><img src="https://jitems.gitee.io/myblog/bk225.png" alt="solar"><h3 id="utils-http-http-js文件-一层封装请求" tabindex="-1"><a class="header-anchor" href="#utils-http-http-js文件-一层封装请求" aria-hidden="true">#</a> utils&gt;http&gt;http.js文件 一层封装请求</h3><p>//post和get请求封装</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">const</span> baseUrl <span class="token operator">=</span> <span class="token string">&quot;XXXXXXXXX&quot;</span><span class="token punctuation">;</span> <span class="token comment">// 测试环境</span>
