...
<span class="token punctuation">)</span>
  ...
  <span class="token punctuation">)</span><span class="token punctuation">,</span>
<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="textfield文本内容不居中问题" tabindex="-1"><a class="header-anchor" href="#textfield文本内容不居中问题" aria-hidden="true">#</a> TextField文本内容不居中问题</h2><p>我们通常在使用textField的时候默认将其border设置为 InputBorder.none，如果我们给textField设置外边框，你会发现，内容竟然居中了</p><img src="https://jitems.gitee.io/myblog/blog/bk533.png" alt="solar"><p>由此可见，当我们给textField设置了外边框，textField的内容就会居中显示，那么剩下的问题就简单了，将外边框设置为透明色即可</p><p>有一点很重要 contentPadding一定要设置上下边距为0</p><p><strong>contentPadding:EdgeInsets.only(top:0,bottom:0)</strong></p><img src="https://jitems.gitee.io/myblog/blog/bk534.png" alt="solar"><p>结果如下：</p><img src="https://jitems.gitee.io/myblog/blog/bk535.png" alt="solar"><h2 id="监听滑动通知" tabindex="-1"><a class="header-anchor" href="#监听滑动通知" aria-hidden="true">#</a> 监听滑动通知</h2><div class="language-dart line-numbers-mode" data-ext="dart"><pre class="language-dart"><code><span class="token class-name">NotificationListener</span><span class="token punctuation">(</span>
