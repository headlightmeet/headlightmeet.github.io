import{_ as s}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as t,c as a,d as e,a as n,e as i}from"./app-oGr5u-1Z.js";const p={},l=n("p",null,"--- title: 自定义返回和物理返回 category:",-1),o=n("ul",null,[n("li",null,"前端 tag:"),n("li",null,"uniapp")],-1),c=n("hr",null,null,-1),u=n("p",null," ",-1),r=i(`<h1 id="自定义返回和物理返回" tabindex="-1"><a class="header-anchor" href="#自定义返回和物理返回" aria-hidden="true">#</a> 自定义返回和物理返回</h1><p>在pages.json中可以使用自己去找的图标样式</p><img src="https://jitems.gitee.io/myblog/bk234.png" alt="solar"><img src="https://jitems.gitee.io/myblog/bk235.png" alt="solar"><img src="https://jitems.gitee.io/myblog/bk236.png" alt="solar"><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">{</span>
