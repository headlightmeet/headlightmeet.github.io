import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,d as t,a as p,e as o}from"./app-PxqKmrwv.js";const e={},c=p("p",null," ",-1),i=o(`<h1 id="tabbar案例" tabindex="-1"><a class="header-anchor" href="#tabbar案例" aria-hidden="true">#</a> tabBar案例</h1><p>目录结构</p><img src="https://jitems.gitee.io/myblog/blog/bk705.png" alt="solar"><p>Index.ets页面，引入user组件和home页面</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span>User<span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;./components/user&#39;</span>
...
<span class="token keyword">export</span>  struct User<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>点击首页</p><img src="https://jitems.gitee.io/myblog/blog/bk706.png" alt="solar"><p>点击推荐</p><img src="https://jitems.gitee.io/myblog/blog/bk707.png" alt="solar">`,13);function u(l,k){return s(),a("div",null,[c,t(" more "),i])}const v=n(e,[["render",u],["__file","tabBar案例.html.vue"]]);export{v as default};
